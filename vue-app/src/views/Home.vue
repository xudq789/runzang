<template>
  <div class="home">
    ...
    <PaymentModal v-model="showPayment" @paymentSuccess="onPaymentSuccess" />
  </div>
</template>
...
import { useOrderLoader } from '../composables/useOrderLoader.js'
...
const { checkAndLoadOrderFromURL } = useOrderLoader()
...
function onPaymentSuccess() {
  console.log('✅ 支付成功，内容已解锁')
  // 滚动到结果区域
  if (resultRef.value?.$el) {
    resultRef.value.$el.scrollIntoView({ behavior: 'smooth' })
  }
}
