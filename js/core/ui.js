...
export function updateUnlockInfo() {
    ...
    // 检查当前服务是否已解锁
    const isCurrentServiceUnlocked = STATE.serviceUnlockedStates[STATE.currentService] || false;
    
    if (isCurrentServiceUnlocked) {
        // 如果当前服务已解锁，更新界面为已解锁状态
